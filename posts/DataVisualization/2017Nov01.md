...
<blockquote class="blockquote">
  <p>However, an interactive graph would be even more appealing and informative to our readers!</p>
</blockquote>
---
...
We have one additional column **Value**. This is the cattle sold in each county in the unit of USD. Time to make an interactive plot of this new data!!
